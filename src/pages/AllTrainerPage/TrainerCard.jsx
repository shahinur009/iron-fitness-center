...
const TrainerCard = ({ trainer }) => {
    ...
    return (
        ...
        <Link to={`/trainer/${_id}`} className="flex p-5 flex-col items-center transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
            ...
            <button className="btn mt-6 btn-lg">See More</button>
        </Link>
